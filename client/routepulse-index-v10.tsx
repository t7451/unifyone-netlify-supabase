 ...
 *
 * v10 (AI grounding — TomTom Traffic + Waze):
 *   - TomTom Traffic incidents + Waze crowdsourced alerts merge into the
 *     per-route incident sets server-side (deduped against agency feeds)
 *   - TomTom live flow (measured current-vs-free-flow speeds) feeds the
 *     risk score, delay estimate, and AI prompt — congestion that hasn't
 *     generated an incident report yet now counts
 *   - "Grounded with live TomTom + Waze data" chip + TomTom/Waze source
 *     labels on incident rows
 */
        ...
        {hasRoute && (
          <Card className="p-6 sm:p-8 mb-8 space-y-4">
            ...
            <div className="pt-2 border-t space-y-1.5">
              ...
              {/* v10: visible when live TomTom/Waze grounding fed this
