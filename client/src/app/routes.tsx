...
const MileageCalculator = lazy(
  () => import("../pages/tools/MileageCalculator")
);
...
const ResellerBreakEven = lazy(
  () => import("../pages/tools/ResellerBreakEven")
);
...
const PlatformComparison = lazy(
  () => import("../pages/geo/PlatformComparison")
);
...
const GigDeductionsGuide = lazy(
  () => import("../pages/geo/GigDeductionsGuide")
);
    ...
    <>
      <Switch>
        ...
        <Route
          ...
          component={() => (
            <>
              <StateTaxGuide slug="kansas-gig-worker-taxes" />
              <GigResourceLinks />
            </>
          )}
        />
        <Route
          ...
          component={() => (
            <>
              <StateTaxGuide slug="new-mexico-gig-worker-taxes" />
              <GigResourceLinks />
            </>
          )}
        />
        <Route
          ...
          component={() => (
            <>
              <StateTaxGuide slug="nebraska-gig-worker-taxes" />
              <GigResourceLinks />
            </>
          )}
        />
        <Route
          ...
          component={() => (
            <>
              <StateTaxGuide slug="mississippi-gig-worker-taxes" />
              <GigResourceLinks />
            </>
          )}
        />
        <Route
          ...
          component={() => (
            <>
              <StateTaxGuide slug="arkansas-gig-worker-taxes" />
              <GigResourceLinks />
            </>
          )}
        />
        <Route
          ...
          component={() => (
            <>
              <StateTaxGuide slug="west-virginia-gig-worker-taxes" />
              <GigResourceLinks />
            </>
          )}
        />
        <Route
          ...
          component={() => (
            <>
              <StateTaxGuide slug="idaho-gig-worker-taxes" />
              <GigResourceLinks />
            </>
          )}
        />
        <Route
          ...
          component={() => (
            <>
              <StateTaxGuide slug="hawaii-gig-worker-taxes" />
              <GigResourceLinks />
            </>
          )}
        />
        <Route
          ...
          component={() => (
            <>
              <StateTaxGuide slug="maine-gig-worker-taxes" />
              <GigResourceLinks />
            </>
          )}
        />
        <Route
          ...
          component={() => (
            <>
              <StateTaxGuide slug="rhode-island-gig-worker-taxes" />
              <GigResourceLinks />
            </>
          )}
        />
