...
const PLAN_CONFIG = [
  {
    ...
    icon: Zap,
    color: "#3B82F6",
    features: ["1 Store", "500 Products", "1,000 Orders/mo", "Basic Analytics"],
    recommended: false,
  },
  {
    slug: "pro",
    ...
    icon: Shield,
    color: "#00D9FF",
    features: ["5 Stores", "10,000 Products", "Unlimited Orders", "Advanced Analytics", "Shopify Sync"],
    recommended: true,
  },
  {
    slug: "enterprise",
    ...
    icon: Crown,
    color: "#F59E0B",
    features: ["Unlimited Stores", "SLA Guarantee", "Dedicated Support", "Custom Integrations"],
    recommended: false,
  },
];
