        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {STARTER_ACTIONS.map(action => (
            <button
              ...
              className="rounded-xl border border-border bg-background/40 p-4 text-left transition-colors hover:border-[#D4A843]/40 hover:bg-[#D4A843]/5"
            >
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-[#D4A843]/10 text-[#D4A843]">
