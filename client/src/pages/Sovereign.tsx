...
const SOVEREIGN_STACK = [
  {
    label: "Local-First Thin Client",
    desc: "Runs on-device. Works offline. You own the glass.",
  },
  {
    label: "On-Device AI",
    desc: "Snapdragon X Elite. Trade secrets never leave the hardware.",
  },
  {
    label: "Off-Grid LoRa Mesh",
  ...
  },
  {
    ...
    desc: "Routing problems solved in seconds, not hours.",
  },
  {
    label: "Automated Revenue Engine",
    desc: "n8n + Zapier + Meta CAPI. Runs 24/7 without you.",
  },
];
...
const TESTIMONIALS = [
  {
    quote:
      "The Cathedral Principle changed how I think about business architecture entirely. This isn't a SaaS — it's sovereignty.",
    name: "Beta Tester",
  ...
  {
    quote:
      "I was one platform ban away from zero. Now I have a structure that can't be shut down.",
    name: "Early Adopter",
  ...
  {
    quote:
      "Agency-grade infrastructure without the agency price tag. This is what I needed 3 years ago.",
      ...
      <div className="min-h-screen bg-[#030712] text-white flex items-center justify-center px-4">
        <div className="max-w-lg w-full text-center">
          ...
          <p className="text-gray-400 text-lg mb-2">
            We'll reach out personally when we're ready to build your Sovereign
            Stack.
          </p>
      ...
      <section className="pt-28 pb-20 px-4 relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto mb-4 leading-relaxed">
            ...
            building it for a handful of serious entrepreneurs.
          </p>
          <p className="text-base text-gray-500 max-w-xl mx-auto mb-10">
            This isn't a course. This isn't another SaaS. This is the{" "}
            <strong className="text-white">Sovereign Stack</strong> — a complete
            corporate and technical architecture designed for resilience.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              You escaped the 9-to-5 just to build a new prison. You're one bad
              client, one algorithm change, one platform ban away from zero.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "One algorithm change and your traffic disappears overnight.",
              },
              {
                icon: "⚠️",
                title: "Legal Exposure",
                desc: "Everything you own is at risk from a single lawsuit or dispute.",
              },
              {
                icon: "⚠️",
                title: "Operational Fragility",
                desc: "You are the business. If you stop, it stops.",
              },
            ].map(item => (
              <div
                key={item.title}
                className="bg-[#0D1526] border border-red-900/30 rounded-xl p-6"
              >
          ...
          <div className="mt-8 text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">
              — Keith Skaggs, Founder of 1Commerce LLC
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Instead of being the business, you build the <em>structure</em>{" "}
              that runs the business. A multi-layered corporate architecture
              designed for resilience, tax efficiency, and sovereign control.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-[#0A0F1E]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              This isn't cloud-based SaaS that can be shut off. This is
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">
              The complete Sovereign Stack implementation. White-glove. Done for
              you.
            </p>
          </div>
            ...
            <div className="border-t border-[#1E3A5F] pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  One-time implementation fee. No recurring SaaS.
                </p>
              </div>
              <Button
                onClick={scrollToForm}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {TESTIMONIALS.map(t => (
              <div
                key={t.name}
                className="bg-[#0D1526] border border-[#1E3A5F] rounded-xl p-6"
              >
      ...
      <section ref={formRef} className="py-16 px-4" id="waitlist">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400">
              This isn't for everyone. We're looking for serious entrepreneurs
              who are ready to own the mountain.
            </p>
          </div>
            ...
            >
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={v =>
                    setFormData(p => ({
                      ...p,
                      monthlyRevenue: v as typeof formData.monthlyRevenue,
                    }))
                  }
                >
              ...
              >
                {joinWaitlist.isPending
                  ? "Submitting..."
                  : "Join the Sovereign Stack Waitlist"}
                {!joinWaitlist.isPending && (
                  <ArrowRight className="ml-2 w-5 h-5" />
                )}
              </Button>
              <p className="text-xs text-gray-500 text-center">
                No spam. No pitch decks. We'll reach out personally when we're
