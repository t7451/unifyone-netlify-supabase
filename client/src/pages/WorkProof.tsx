...
const PHASES = [
  ...
  { phase: 4, title: "Authentication & OAuth", status: "complete", deliverables: ["OAuth", "JWT tokens", "Protected routes"] },
  ...
  { phase: 25, title: "Kai AI Integration", status: "complete", deliverables: ["AI chat widget", "Context panels", "Drip emails"] },
  ...
  { phase: 27, title: "Kai AI Marketing", status: "complete", deliverables: ["Hero visuals", "Feature banner", "Social cards"] },
  ...
  { phase: 33, title: "Multi-Page Architecture", status: "complete", deliverables: ["/architecture", "/the-system", "/tithes"] },
...
const ACHIEVEMENTS = [
  ...
  { category: "AI & Automation", items: ["Kai AI integration", "Claude MCP support", "5-email drip sequence", "Context-aware suggestions"] },
