...
export default function Login() {
  ...
  const handleContinue = () => {
    ...
    const returnTo =
      location && location !== "/login" && location !== "/auth/callback"
        ? location
        : "/dashboard";
    const oauthUrl = `${getOAuthUrl()}?returnTo=${encodeURIComponent(returnTo)}`;
        ...
        <div className="w-full max-w-[400px] space-y-8">
          ...
          <div className="flex items-start gap-2 p-3 rounded-lg bg-white/3 border border-white/5">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              Your sign-in is protected by enterprise-grade OAuth 2.0 with JWT
              session tokens. UnifyOne never stores your password.
            </p>
          </div>
