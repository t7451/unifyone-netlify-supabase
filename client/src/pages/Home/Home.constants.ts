...
export const JSON_LD = [
  {
    ...
    "@id": CANONICAL,
    url: CANONICAL,
    name: "UnifyOne by 1Commerce — Gig Earnings & Tax Tracker for 1099 Workers",
    description:
  ...
  },
  {
    ...
    alternateName: ["UnifyOne", "1Commerce", "1 Commerce"],
  ...
  },
  {
    ...
    name: "1Commerce",
    alternateName: ["UnifyOne", "1 Commerce", "OneCommerce", "PNW Enterprises"],
    url: SITE_URL,
