  ...
  return (
    <div className="min-h-screen bg-background">
      <PageHead
        ...
        description="UnifyOne Terms of Service — usage terms, subscription billing, the Promote & Earn program, data ownership, and liability limits. 1Commerce LLC."
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8 text-foreground/90">
          ...
          <section>
            ...
            <p>
              The Service is offered on a subscription basis. By subscribing,
              you agree to pay the applicable fees. Subscriptions auto-renew
              unless cancelled before the renewal date. Refunds are handled on a
            ...
            <p className="mt-2">
              Payment processing is handled by Stripe and PayPal. By providing
              payment information, you agree to their respective terms of
              service.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">
              5. Promote & Earn Program
            </h2>
            <p>
              The Promote & Earn referral program allows users to earn credits
              by sharing UnifyOne on social media and referring new users.
              Credits are:
            </p>
            <ul className="list-disc pl-6 space-y-1 mt-2 text-sm">
              <li>
                Non-transferable and have no cash value outside of subscription
                credits
              </li>
              <li>
                Applied as discounts against future subscription invoices only
              </li>
              <li>Subject to a minimum redemption of 100 credits ($1.00)</li>
              <li>Forfeited upon account termination</li>
            </ul>
            <p className="mt-2">
              All promotional content must include FTC-required disclosure
              language. Fraudulent referrals (self-referrals, fake accounts)
              will result in credit forfeiture and possible account termination.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1 mt-2 text-sm">
              ...
              <li>
                Scrape, crawl, or extract data from the Service without
                authorization
              </li>
              <li>
              ...
              <li>
                Use the Service to process transactions for illegal goods or
                services
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              (products, orders, customer records). We do not claim ownership of
              your data. You grant us a limited license to process your data
          ...
          <section>
            ...
            <p>
              ...
              access. We may perform maintenance with advance notice when
              possible. We are not liable for downtime caused by third-party
              services (Stripe, PayPal, Shopify, Supabase).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              termination, your access to the Service will cease. You may export
              your data within 30 days of termination. After 30 days, we may
              delete your data.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              Disputes shall be resolved in the courts of Multnomah County,
              Oregon.
            </p>
          </section>
