...
/**
 * Use-case layer for the PixelForge router — wraps MCP tool dispatch scoped to
 * the caller's tenant. Transport (procedures + zod) stays in index.ts.
...
export async function callPixelTool(
  tenantId: number,
  tool: string,
