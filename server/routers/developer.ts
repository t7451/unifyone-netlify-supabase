    ...
    return {
      ...
      namespaces: [
        ...
        },
        {
          ...
          procedures: [
            { name: "dealflow.listDeals", type: "query", description: "List deals with category/difficulty filters" },
            { name: "dealflow.getDeal", type: "query", description: "Get a single deal by ID" },
            { name: "dealflow.searchDeals", type: "query", description: "Full-text search across deals" },
            { name: "dealflow.getRecommendations", type: "query", description: "Personalized deal recommendations" },
            { name: "dealflow.manageWishlist", type: "mutation", description: "Add/remove/list wishlist items" },
            { name: "dealflow.trackConversion", type: "mutation", description: "Record click or conversion event" },
            { name: "dealflow.generateContent", type: "mutation", description: "AI-generated content for a deal" },
            { name: "dealflow.getFeatureFlags", type: "query", description: "List A/B test feature flags" },
            { name: "dealflow.setFeatureFlag", type: "mutation", description: "Enable/disable a feature flag" },
          ],
        },
        {
          name: "terpforge",
          ...
          procedures: [
            { name: "terpforge.listCompounds", type: "query", description: "List terpene compounds with molecular data" },
            { name: "terpforge.getCompound", type: "query", description: "Get detailed molecular data for a compound" },
            { name: "terpforge.simulatePurity", type: "mutation", description: "Run a purity simulation" },
            { name: "terpforge.getCoaData", type: "query", description: "Retrieve COA lab results" },
            { name: "terpforge.listProducts", type: "query", description: "List products by category" },
            { name: "terpforge.compareProfiles", type: "query", description: "Compare terpene compounds side-by-side" },
          ],
        },
        {
          name: "knowledgeGraph",
          ...
          procedures: [
            { name: "knowledgeGraph.queryGraph", type: "query", description: "Query graph nodes and edges" },
            { name: "knowledgeGraph.getStats", type: "query", description: "Aggregated graph statistics" },
            { name: "knowledgeGraph.triggerIngest", type: "mutation", description: "Trigger a data ingestion run" },
            { name: "knowledgeGraph.searchNodes", type: "query", description: "Full-text search across nodes" },
            { name: "knowledgeGraph.getBrainActivity", type: "query", description: "Recent Brain layer activity" },
            { name: "knowledgeGraph.getConnectors", type: "query", description: "List configured data connectors" },
          ],
        },
        {
          name: "pixelforge",
          description: "PixelForge Studio — pixel art editor and HTML5 game creation",
          procedures: [
            { name: "pixelforge.listAssets", type: "query", description: "List pixel art assets for a tenant" },
            { name: "pixelforge.getAsset", type: "query", description: "Get a single asset with frame data" },
            { name: "pixelforge.createAsset", type: "mutation", description: "Create a new pixel asset record" },
            { name: "pixelforge.exportSpriteSheet", type: "mutation", description: "Export frames as PNG sprite sheet" },
            { name: "pixelforge.getMetadata", type: "query", description: "Get asset metadata" },
          ],
        },
        {
          name: "shopifyTheme",
          ...
          procedures: [
            { name: "shopifyTheme.getSections", type: "query", description: "List all available theme sections" },
            { name: "shopifyTheme.syncConfig", type: "mutation", description: "Push updated settings to Shopify" },
            { name: "shopifyTheme.getPerformance", type: "query", description: "Lighthouse/performance metrics" },
            { name: "shopifyTheme.updateSection", type: "mutation", description: "Update a specific section's settings" },
            { name: "shopifyTheme.getLoyaltyConfig", type: "query", description: "Get loyalty program configuration" },
          ],
        },
      ],
    };
